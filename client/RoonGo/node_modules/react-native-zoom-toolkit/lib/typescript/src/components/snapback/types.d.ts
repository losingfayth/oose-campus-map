...
import type { CommonZoomState, PinchGestureCallbacks, SizeVector, TapGestureCallbacks } from '../../commons/types';
...
}> & PinchGestureCallbacks & TapGestureCallbacks;
