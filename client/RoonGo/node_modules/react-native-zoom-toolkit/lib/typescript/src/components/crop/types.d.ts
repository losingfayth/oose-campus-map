...
import type { CommonResumableProps, PanGestureCallbacks, PinchGestureCallbacks, SizeVector, TapGestureCallbacks } from '../../commons/types';
...
export type CropAssignableState = Omit<CropZoomState<number>, 'width' | 'height'>;
