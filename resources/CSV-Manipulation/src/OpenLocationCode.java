...
public final class OpenLocationCode {
    ...
    // Provides a normal precision code, approximately 3x3 meters.
    public static final int CODE_PRECISION_NORMAL = 11;

    // The character set used to encode the values.
    public static final String CODE_ALPHABET = "23456789CFGHJMPQRVWX";

    public static final String CAMPUS_LOC_GRID = "87H5";
