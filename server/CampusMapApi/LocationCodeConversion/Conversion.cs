...
public class CoordinateConverter
{
    ...
    public class Coordinate
    {
        ...
        /// </summary>
        /// <param name="x">The first latitude/longitude coordinate</param>
        /// <param name="y">The second latitude/longitude coordinate</param>
        ...
        public static double GetDistance(Coordinate x, Coordinate y, DistanceMetric metric)
        {
            double deltaLng = DegreesToRadians(x._longitude) - DegreesToRadians(y._longitude);
            double deltaLat = DegreesToRadians(x._latitude) - DegreesToRadians(y._latitude);

            double a = Math.Pow(Math.Sin(deltaLat / 2), 2) + Math.Cos(x._latitude) * Math.Cos(y._latitude) * Math.Pow(Math.Sin(deltaLng / 2), 2);
        ...
        {
            return GetDistance(x, y, DistanceMetric.Feet);
        }
    ...
    private static void TestDistanceFunction() {
    ...
    private static void TestBloomEncoding()
    {
